 ...
 */
public enum DirectoryIdentifierOrig
{
    IFD_BASELINE_DIRECTORY(-1, "IFD"),
    IFD_GPS_DIRECTORY(-2, "GPS IFD"),
    EXIF_INTEROP_DIRECTORY(-3, "Interop IFD"),
    EXIF_SUBIFD_DIRECTORY(-4, "Exif SubIFD"),
     ...
     */
    private DirectoryIdentifierOrig(final int directoryType, final String description)
    {
     ...
     */
    public static DirectoryIdentifierOrig getDirectoryType(int index)
    {
        for (DirectoryIdentifierOrig tifDirType : values())
        {
     ...
     */
    public static DirectoryIdentifierOrig getNextDirectoryType(DirectoryIdentifierOrig dirType)
    {
