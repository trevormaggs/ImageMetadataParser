 ...
 */
public class TifParserOrig extends AbstractImageParser
{
    private static final LogFactory LOGGER = LogFactory.getLogger(TifParserOrig.class);
     ...
     */
    public TifParserOrig(String file) throws IOException
    {
        this(Paths.get(file));
    }
     ...
     */
    public TifParserOrig(Path fpath) throws IOException
    {
        super(fpath);
