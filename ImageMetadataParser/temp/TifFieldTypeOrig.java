...
public enum TifFieldTypeOrig
{
     ...
     */
    private TifFieldTypeOrig(int fmt, String desc, int len)
    {
        dataType = fmt;
        description = desc;
        elementLength = len;
     ...
     */
    public static TifFieldTypeOrig getTiffType(int typeCode)
    {
        for (TifFieldTypeOrig type : values())
        {
