 ...
 */
public class ImageFileInputStreamTest implements ByteStreamReader, AutoCloseable
{
     ...
     */
    public ImageFileInputStreamTest(InputStream fin, ByteOrder order)
    {
        if (fin == null)
        {
     ...
     */
    public ImageFileInputStreamTest(InputStream fin)
    {
     ...
     *         if the file path
     */
    public ImageFileInputStreamTest(Path fpath, ByteOrder order) throws IOException
    {
     ...
     */
    public ImageFileInputStreamTest(Path fpath) throws IOException
    {
