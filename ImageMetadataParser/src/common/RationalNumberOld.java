...
public class RationalNumberOld extends Number
{
     ...
     */
    private RationalNumberOld(long num, long div, DataType type)
    {
        this.unsignedType = (type == DataType.UNSIGNED);
        this.numerator = num;
        this.divisor = div;
    ...
    /**
     * Negates the value of the RationalNumberOld. If the numerator of this instance has its high-order
     * bit set, then its value is too large to be treated as a Java 32-bit signed integer. In such a
     * case, the only way that a RationalNumberOld instance can be negated is to divide both terms by a
    ...
    public RationalNumberOld negate()
    {
        ...
        return new RationalNumberOld(-n, d, DataType.SIGNED);
    }
     ...
     * 
     * @return An instance of the RationalNumberOld class, representing the simplified fraction
     */
    public static RationalNumberOld simplifyLargeFraction(long numerator, long divisor, boolean unsignedType)
    {
        long gcd;
        long n = numerator;
        long d = divisor;
        ...
        return new RationalNumberOld(n / gcd, d / gcd, (unsignedType ? DataType.UNSIGNED : DataType.SIGNED));
    }
    ...
    public String toSimpleString(boolean decimalAllowed)
    {
        ...
        {
            RationalNumberOld simplifiedInstance = simplifyLargeFraction(numerator, divisor, unsignedType);
