...
public final class TagValueConverter2
{
    ...
    /**
     * Returns the value of the entry as a long.
     *
     * @param entry
     *        the entry to convert
    ...
    /**
     * Returns the value of the entry as a float.
     *
     * @param entry
     *        the entry to convert
    ...
    /**
     * Returns the value of the entry as a double.
     *
     * @param entry
     *        the entry to convert
    ...
    /**
     * Retrieves the data from an entry as an int array.
     *
     * @param entry
     *        the {@link EntryIFD} to retrieve
    ...
    /**
     * Retrieves the data from an entry as a short array.
     *
     * @param entry
     *        the {@link EntryIFD} to retrieve
    ...
    /**
     * Retrieves the data from an entry as a long array.
     *
     * @param entry
     *        the {@link EntryIFD} to retrieve
    ...
    /**
     * Retrieves the data from an entry as a byte array.
     *
     * @param entry
     *        the {@link EntryIFD} to retrieve
    ...
    /**
     * Retrieves the data from an entry as a RationalNumber array.
     *
     * @param entry
     *        the {@link EntryIFD} to retrieve
     ...
     *
     * <p>
     * This method handles specific formatting for GPS coordinates (DMS), Rational arrays, and encoded string types like UserComments.
     * </p>
     *
     * @param entry
     *        the entry to format
