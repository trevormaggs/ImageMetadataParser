 ...
 */
public enum DirectoryIdentifier3
{
    ...
    public static final DirectoryIdentifier3 IFD_ROOT_DIRECTORY = IFD_DIRECTORY_IFD0;
    public static final DirectoryIdentifier3 IFD_THUMBNAIL_DIRECTORY = IFD_DIRECTORY_IFD1;
     ...
     */
    private DirectoryIdentifier3(final String description)
    {
     ...
     * 
     */
    public static DirectoryIdentifier3 getNextDirectoryType(DirectoryIdentifier3 dirType)
    {
        switch (dirType)
        {
            case IFD_DIRECTORY_IFD0:
