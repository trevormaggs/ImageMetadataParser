...
public enum TagIFD_GPSOld implements Taggable
{
    ...
    GPS_PROCESSING_METHOD(0X001B, IFD_GPS_DIRECTORY, TagHint.HINT_ENCODED_STRING),
    ...
    private TagIFD_GPSOld(int id, DirectoryIdentifier dir)
    {
        this(id, dir, TagHint.HINT_DEFAULT);
    }

    private TagIFD_GPSOld(int id, DirectoryIdentifier dir, TagHint clue)
    {
        numID = id;
        directory = dir;
        hint = clue;
