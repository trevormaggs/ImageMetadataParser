...
public enum TagIFD_PrivateOld implements Taggable
{
    ...
    IFD_PREVIEW_DATE_TIME(0xC71B, DirectoryIdentifier.IFD_ROOT_DIRECTORY, "Preview Date Time"),
    ...
    private TagIFD_PrivateOld(int id, DirectoryIdentifier dir, String desc)
    {
        this(id, dir, desc, TagHint.HINT_DEFAULT);
    }

    private TagIFD_PrivateOld(int id, DirectoryIdentifier dir, String desc, TagHint clue)
    {
        this.numID = id;
        this.directory = dir;
        this.desc = desc;
