...
public enum TagIFD_Exif2 implements Taggable
{
    ...
    EXIF_SUBJECT_DISTANCE(0x9206, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Subject Distance", TagHint.HINT_DEFAULT),
    ...
    EXIF_FLASHPIX_VERSION(0xA000, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Flashpix Version", TagHint.HINT_STRING),
    EXIF_IMAGE_UNIQUE_ID(0xA420, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Image Unique ID", TagHint.HINT_DEFAULT),
    ...
    /*
     * -----------------------------------------------------------------------------------------
     * Hardware & Lens Details
     * -----------------------------------------------------------------------------------------
     */
    EXIF_LENS_SPECIFICATION(0xA432, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Lens Specification", TagHint.HINT_DEFAULT),
    ...
    EXIF_SENSING_METHOD(0xA217, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Sensing Method", TagHint.HINT_DEFAULT),
    ...
    EXIF_CUSTOM_RENDERED(0xA401, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Custom Rendered", TagHint.HINT_DEFAULT),
    EXIF_WHITE_BALANCE(0xA403, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "White Balance", TagHint.HINT_DEFAULT),
    EXIF_DIGITAL_ZOOM_RATIO(0xA404, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Digital Zoom Ratio", TagHint.HINT_DEFAULT),
    EXIF_FOCAL_LENGTH_IN35MM_FILM(0xA405, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Focal Length In 35mm Film", TagHint.HINT_DEFAULT),
    ...
    /*
     * -----------------------------------------------------------------------------------------
     * DNG Specific Tags (Digital Negative)
     * -----------------------------------------------------------------------------------------
     */
    ...
    EXIF_COLOR_MATRIX1(0xC621, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Color Matrix 1", TagHint.HINT_DEFAULT),
    EXIF_COLOR_MATRIX2(0xC622, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Color Matrix 2", TagHint.HINT_DEFAULT),
    EXIF_AS_SHOT_NEUTRAL(0xC628, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "As Shot Neutral", TagHint.HINT_DEFAULT),

    /*
     * -----------------------------------------------------------------------------------------
     * Windows XP Specific Tags
     * -----------------------------------------------------------------------------------------
     */
    EXIF_XPTITLE(0x9C9B, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "XP Title", TagHint.HINT_DEFAULT),
    EXIF_XPCOMMENT(0x9C9C, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "XP Comment", TagHint.HINT_DEFAULT),
    EXIF_XPAUTHOR(0x9C9D, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "XP Author", TagHint.HINT_DEFAULT),
    EXIF_XPKEYWORDS(0x9C9E, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "XP Keywords", TagHint.HINT_DEFAULT),
    EXIF_XPSUBJECT(0x9C9F, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "XP Subject", TagHint.HINT_DEFAULT),

    /*
     * -----------------------------------------------------------------------------------------
     * Miscellaneous & Interop
     * -----------------------------------------------------------------------------------------
     */
    ...
    EXIF_IMAGE_RATING(0x4746, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Rating", TagHint.HINT_DEFAULT),
    EXIF_IMAGE_RATING_PERCENT(0x4749, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Rating Percent", TagHint.HINT_DEFAULT);
