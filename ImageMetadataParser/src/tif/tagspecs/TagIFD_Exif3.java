...
public enum TagIFD_Exif3 implements Taggable
{
    ...
    EXIF_XPTITLE(0x9C9B, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Windows XP Title", TagHint.HINT_DEFAULT),
    EXIF_XPCOMMENT(0x9C9C, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Windows XP Comment", TagHint.HINT_DEFAULT),
    EXIF_IMAGE_RATING(0x4746, DirectoryIdentifier.IFD_EXIF_SUBIFD_DIRECTORY, "Rating (0-5)", TagHint.HINT_DEFAULT),
    ...
    private TagIFD_Exif3(int id, DirectoryIdentifier dir, String desc, TagHint clue)
    {
        this.numID = id;
        this.directory = dir;
        this.desc = desc;
    ...
    private TagIFD_Exif3(int id, DirectoryIdentifier dir)
    {
