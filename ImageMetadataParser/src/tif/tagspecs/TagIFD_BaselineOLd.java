...
public enum TagIFD_BaselineOLd implements Taggable
{
    ...
    private TagIFD_BaselineOLd(int id, DirectoryIdentifier dir, String desc)
    {
        this(id, dir, desc, TagHint.HINT_DEFAULT);
    }

    private TagIFD_BaselineOLd(int id, DirectoryIdentifier dir, String desc, TagHint clue)
    {
        this.numID = id;
        this.directory = dir;
        this.desc = desc;
