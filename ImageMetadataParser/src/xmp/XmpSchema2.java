...
public enum XmpSchema2
{
    ...
    private static final Map<String, XmpSchema2> NAME_LOOKUP = new HashMap<>();

    static
    {
        for (XmpSchema2 type : values())
        {
    ...
    private XmpSchema2(String propName, NameSpace schema)
    {
     ...
     */
    public static XmpSchema2 fromPropertyName(String propName)
    {
        if (propName == null)
        {
            return UNKNOWN;
